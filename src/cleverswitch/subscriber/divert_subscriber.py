...
from ..hidpp.constants import FEATURE_REPROG_CONTROLS_V4, MAP_FLAG_DIVERTED, SW_ID
...
class DivertSubscriber(Subscriber):
    ...
    def notify(self, event) -> None:
        ...
        for cid in event.cids:
            ...
            log.info("%s CID 0x%04X on slot=%d", "Diverting" if event.divert else "Undiverting", cid, event.slot)
